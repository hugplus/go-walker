...
import (
	...
	"github.com/hugplus/go-walker/common/third/file_store/config"
...
func (e *AwsS3) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	return e.cfg.BaseURL + "/" + filename, fileKey, nil
}
